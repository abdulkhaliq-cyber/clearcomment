...
export default function Register() {
    ...
    const createFirestoreUser = async (user: any, displayName?: string) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await createFirestoreUser(user, name);
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4">
            <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-600">Get started with ClearComment</p>
                </div>
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-6 space-y-3">
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full py-3 border-2 border-slate-300 rounded-lg font-semibold text-slate-700 hover:bg-slate-50 transition flex items-center justify-center gap-3"
                        >
